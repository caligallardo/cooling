function [dataTable] = get_fridge_data (filename)
    ...
    reset = 1;
    c = {'Time','OutTemp','OutHum','InTemp','InHum','Soil','Infrared','Reset'}; % create cell array to convert to table
